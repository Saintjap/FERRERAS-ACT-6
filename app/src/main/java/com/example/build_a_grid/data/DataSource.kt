...
object DataSource {
    val topics = listOf(
        Topic(R.string.architecture, 58, R.drawable.archi_2),
        Topic(R.string.automotive, 30, R.drawable.automotive_2),
        Topic(R.string.biology, 90, R.drawable.biology_2),
        Topic(R.string.crafts, 121, R.drawable.crafts_2),
        Topic(R.string.business, 78, R.drawable.business_2),
        Topic(R.string.culinary, 118, R.drawable.culinary_2),
